...
#         elif query.lower() in appointment[2].lower():
#             results.append(appointment)
#         elif query.lower() in appointment[1].lower():
#             results.append(appointment)
#     if len(results) == 0:
...
#             output += f"Date: {appointment[0]}, Time: {appointment[1]}, Description: {appointment[2]}, Image: {appointment[3]}<br>"
#         return output
