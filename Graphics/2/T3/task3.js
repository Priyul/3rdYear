...
function drawScene(time) {
  ...
  //     time = 0;
  //   }
  const rotationMatrix = rotateY(time/5); 
  // const rotationMatrix = rotateY(270); 
  ...
  drawPart(gl, frontWallBuffer, frontWallVertices, frontWallColor); // Front wall
  drawPart(gl, leftWallBuffer, leftWallVertices, leftWallColor); // Left wall
  drawPart(gl, rightWallBuffer, rightWallVertices, rightWallColor); // Right wall
  drawPart(gl, backWallBuffer, backWallVertices, backWallColor); // Back wall
